...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
        <a href="index.html" class="navbar-brand d-block d-lg-none">
            <h1 class="font-secondary text-white mb-n2"><?=$SETTING['titulo_principal'] ?? ''?></h1>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <a href="<?=ROOT?>/#index.html" class="navbar-brand mx-5 d-none d-lg-block">
                <h1 class="font-secondary text-white mb-n2"><?=APP_NAME?></h1>
            </a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="height: 100vh; min-height: 400px;">
                    <img class="position-absolute w-100 h-100" src="<?=get_image($SETTING['hero_bg']) ?? ''?>" style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-1 font-secondary text-white mt-n3 mb-md-4"><?=$SETTING['titulo_principal']?></h1>
                        ...
                        <div class="row m-0 mb-4 mb-md-0 pb-2 pb-md-0">
                            <div class="col-md-6 p-0 text-center text-md-right">
                                <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-5">
                                    ...
                                    <p><?=$row->description?></p>
                                    <h3 class="font-secondary font-weight-normal text-muted mb-3"><i class="fa fa-<?=$row->icon?> text-primary pr-3"></i><?=$row->name?></h3>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-md-6 p-0 text-center text-md-left">
                                <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-5">
                                    ...
                                    <h3 class="font-secondary font-weight-normal text-muted mb-3"><i class="fa fa-<?=$row->icon?> text-primary pr-3"></i><?=$row->name?></h3>
                                    <div class="position-relative">
                                        <a class="btn btn-outline-primary btn-square mr-1" href="<?=esc($row->twitter_link)?>"><i class="fab fa-twitter"></i></a>
                                        <a class="btn btn-outline-primary btn-square mr-1" href="<?=esc($row->facebook_link)?>"><i class="fab fa-facebook-f"></i></a>
                                        <a class="btn btn-outline-primary btn-square mr-1" href="<?=esc($row->linkedin_link)?>"><i class="fab fa-linkedin-in"></i></a>
                                        <a class="btn btn-outline-primary btn-square" href="<?=esc($row->instagram_link)?>"><i class="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php foreach($stories as $row): $num++; ?>
                        ...
                        ?>
                            <div class="row">
                                <div class="col-md-6 text-center text-md-right">
                                    <img class="img-fluid mr-md-3" src="<?=get_image($row->image)?>" style="max-width:300px;height:300px;object-fit:cover;">
                                </div>
                                <div class="col-md-6 text-center text-md-left">
                                    <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 ml-md-3">
                                        <h4 class="mb-2"><?=$row->title?></h4>
                        ...
                        <?php else: ?>
                            <div class="row">
                                ...
                                <div class="col-md-6 text-center text-md-left">
                                    <img class="img-fluid ml-md-3" src="<?=get_image($row->image)?>" style="max-width:300px;height:300px;object-fit:cover;">
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <?php if(!empty($gallery)): ?>
                <?php foreach($gallery as $image_row): ?>
                    <div class="gallery-item">
                        <img class="img-fluid w-100" src="<?=get_image($image_row->image)?>" alt="">
                    ...
                    <?php foreach($family as $row): ?>
                        <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
                            <div class="position-relative mb-2">
                                <img class="img-fluid w-100" src="<?=get_image($row->image)?>" style="height:350px;object-fit:cover;">
                                <div class="bg-secondary text-center p-4">
                                    <h5 class="mb-3"><?=$row->name?></h5>
                                    <p class="text-uppercase"><?=$row->title?></p>
                        ...
                        <form method="post" onsubmit="submit_form(event)">
                            <div class="form-row">
                                <div class="form-group col-sm-6">
                                    <input name="name" type="text" class="form-control bg-secondary border-0 py-4 px-3" placeholder="Your Name"/>
                                </div>
                                <div class="form-group col-sm-6">
                                    <input name="email" type="email" class="form-control bg-secondary border-0 py-4 px-3" placeholder="Your Email"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-sm-6">
    ...
    <div class="container-fluid bg-dark text-white py-5" id="contact" style="margin-top: 90px;">
        <div class="container text-center py-5">
            ...
            <div class="d-flex justify-content-center mb-4">
                <a class="btn btn-lg btn-outline-light btn-lg-square mr-2" target="_blank" href="<?=$social_links->twitter_link ?? '#'?>"><i class="fab fa-twitter"></i></a>
                <a class="btn btn-lg btn-outline-light btn-lg-square mr-2" target="_blank" href="<?=$social_links->facebook_link ?? '#'?>"><i class="fab fa-facebook-f"></i></a>
                <a class="btn btn-lg btn-outline-light btn-lg-square mr-2" target="_blank" href="<?=$social_links->linkedin_link ?? '#'?>"><i class="fab fa-linkedin-in"></i></a>
                <a class="btn btn-lg btn-outline-light btn-lg-square" target="_blank" href="<?=$social_links->instagram_link ?? '#'?>"><i class="fab fa-instagram"></i></a>
            </div>
            <div class="d-flex justify-content-center py-2">
                <a href="<?=ROOT?>admin">Admin</a>&nbsp | &nbsp;
                <p class="text-white" href="mailto:<?=$social_links->email ?? '#'?>"><?=$social_links->email ?? 'email@email.com'?></p>
                <span class="px-3">|</span>
                <p class="text-white" href="#"><?=$social_links->phone ?? '999-999-999'?></p>
            </div>
            <p class="m-0">&copy; <a class="text-primary" href="#">Domain Name</a>. Designed by <a class="text-primary" href="#"><?=$SETTING['design']?></a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
